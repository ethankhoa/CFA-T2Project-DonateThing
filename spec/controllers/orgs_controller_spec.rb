...
RSpec.describe OrgsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested org as @org" do
      org = Org.create! valid_attributes
      get :show, params: {id: org.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested org as @org" do
      org = Org.create! valid_attributes
      get :edit, params: {id: org.to_param}, session: valid_session
      expect(assigns(:org)).to eq(org)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Org" do
        expect {
          post :create, params: {org: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved org as @org" do
        post :create, params: {org: invalid_attributes}, session: valid_session
        expect(assigns(:org)).to be_a_new(Org)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested org" do
        org = Org.create! valid_attributes
        put :update, params: {id: org.to_param, org: new_attributes}, session: valid_session
        org.reload
      ...
      it "assigns the requested org as @org" do
        org = Org.create! valid_attributes
        put :update, params: {id: org.to_param, org: valid_attributes}, session: valid_session
        expect(assigns(:org)).to eq(org)
      end
    ...
    context "with invalid params" do
      it "assigns the org as @org" do
        org = Org.create! valid_attributes
        put :update, params: {id: org.to_param, org: invalid_attributes}, session: valid_session
        expect(assigns(:org)).to eq(org)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested org" do
      org = Org.create! valid_attributes
      expect {
        delete :destroy, params: {id: org.to_param}, session: valid_session
      }.to change(Org, :count).by(-1)
    end
